...
def tela_usuario_nao_pagante(id):
    ...
    with coluna3:
        ...
        st.warning('Você está no modo gratuito. Caso deseje assinar para ter acesso a novas funcionalidades, entre em contato com o desenvolvedor.')
        



    # Abas
    visao_geral,  = st.tabs(['Visão Geral'])
