...
from dados import obter_media_jogadores_por_edicao, calcular_valores_e_quantidade_torneios,obter_nome_pessoa,obter_adversarios_e_resultados,calcular_winrate
from graficos import *
